...
CeruleanMartClerkText::
	script_mart POKE_BALL, BICYCLE, TM_BUBBLEBEAM, POTION, REPEL, ESCAPE_ROPE, ANTIDOTE, PARLYZ_HEAL, AWAKENING, BURN_HEAL
...
CinnabarMartClerkText::
	script_mart MASTER_BALL, BICYCLE, MOON_STONE, OLD_AMBER, DOME_FOSSIL, HELIX_FOSSIL, ULTRA_BALL, HYPER_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL, REVIVE, TM_BUBBLEBEAM, TM_DIG, TM_TRI_ATTACK, TM_MIMIC, TM_SELFDESTRUCT, TM_PSYWAVE, TM_METRONOME, TM_SKULL_BASH

...
CinnabarMartClerkText::
	script_mart MASTER_BALL, BICYCLE, MOON_STONE, OLD_AMBER, DOME_FOSSIL, HELIX_FOSSIL, ULTRA_BALL, HYPER_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL, REVIVE, TM_BUBBLEBEAM, TM_DIG, TM_MIMIC, TM_METRONOME, TM_SELFDESTRUCT, TM_SKULL_BASH, TM_PSYWAVE, TM_TRI_ATTACK
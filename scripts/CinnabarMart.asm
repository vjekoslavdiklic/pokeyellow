...
CinnabarMartClerkText::
	script_mart MASTER_BALL,RARE_CANDY, BICYCLE, MOON_STONE, OLD_AMBER, DOME_FOSSIL, HELIX_FOSSIL, HYPER_POTION, MAX_REPEL, ESCAPE_ROPE, TM_BUBBLEBEAM, TM_DIG, TM_MIMIC, TM_METRONOME, TM_SELFDESTRUCT, TM_SKULL_BASH, TM_PSYWAVE, TM_TRI_ATTACK